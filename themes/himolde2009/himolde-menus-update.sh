...
kurssidemal="/usr/share/drupal/sites/kvalitet/themes/himolde/himolde-menus.html"
...
wget -q -O $tmpfil 'http://www2.himolde.no/content/api/HSM/TOC/css_hovedmeny.htm'
